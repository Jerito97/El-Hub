...
export function PushToggle({ vapidPublicKey }: { vapidPublicKey: string }) {
  ...
  return (
    <div style={{ marginTop: 10, padding: "14px", background: "var(--color-surface)", borderRadius: "var(--radius-md)", boxShadow: "var(--shadow-card)", display: "flex", alignItems: "center", gap: 12 }}>
      <span style={{ flex: 1 }}>
