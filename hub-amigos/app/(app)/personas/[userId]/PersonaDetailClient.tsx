  ...
  return (
    <div style={{ padding: "18px 18px 30px" }}>
      ...
      <div style={{ marginTop: 18, display: "flex", alignItems: "center", gap: 14 }}>
        <div style={{ width: 60, height: 60, flex: "none", background: "var(--color-accent-600)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-heading)", fontWeight: 900, fontSize: 22 }}>{initials}</div>
        <div>
      ...
      <div style={{ marginTop: 20, borderTop: "2px solid var(--color-divider)", paddingTop: 14 }}>
        ...
        {alias ? (
          <div style={{ marginTop: 9, display: "flex", alignItems: "stretch", border: "2px solid var(--color-text)" }}>
            <div style={{ flex: 1, minWidth: 0, padding: "11px 12px", background: "var(--color-neutral-100)", fontFamily: "var(--font-heading)", fontWeight: 800, fontSize: 14, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{alias}</div>
            <button type="button" onClick={copy} style={{ flex: "none", background: "var(--color-accent-600)", color: "#fff", border: 0, borderLeft: "2px solid var(--color-text)", padding: "0 14px", cursor: "pointer", fontFamily: "var(--font-heading)", fontWeight: 800, fontSize: 12, textTransform: "uppercase", letterSpacing: ".05em" }}>
      ...
      <div style={{ marginTop: 20, borderTop: "2px solid var(--color-divider)", paddingTop: 14, display: "flex", alignItems: "center", gap: 12 }}>
        <div style={{ flex: 1 }}>
